...
class SearchProductViewController: AnimationViewController {
    ...
    fileprivate func buildSearchBar() {
        ...
        leftBtn!.addTarget(self, action: "leftButtonClcik", for: UIControlEvents.touchUpInside)
        ...
        if data != nil {
            ...
            if array?.count > 0 {
                hotSearchView = SearchView(frame: CGRect(x: 10, y: 20, width: ScreenWidth - 20, height: 100), searchTitleText: "热门搜索", searchButtonTitleTexts: array!) { (sender) -> () in
                    ...
                    tmpSelf!.loadProductsWithKeyword(sender.title(for: UIControlState())!)
                }
    ...
    fileprivate func buildCleanHistorySearchButton() {
        ...
        cleanHistoryButton.setTitleColor(UIColor.colorWithCustom(163, g: 163, b: 163), for: UIControlState())
        ...
        cleanHistoryButton.addTarget(self, action: "cleanSearchHistorySearch", for: UIControlEvents.touchUpInside)
