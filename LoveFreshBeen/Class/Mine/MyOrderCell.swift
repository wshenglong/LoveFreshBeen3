...
//            }
            ...
            for i in 0..<buttons!.count {
                ...
                btn.setTitle(buttons![i].text, for: UIControlState())
                btn.addTarget(self, action: "orderButtonClick:", for: UIControlEvents.touchUpInside)
                addSubview(btn)
            }
        }
    }
    ...
    func orderButtonClick(_ sender: UIButton) {
