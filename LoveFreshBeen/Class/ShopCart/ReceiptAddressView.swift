...
class ReceiptAddressView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        modifyButton.setTitle("修改", for: UIControlState())
        modifyButton.setTitleColor(UIColor.red, for: UIControlState())
        modifyButton.addTarget(self, action: "modifyButtonClick", for: UIControlEvents.touchUpInside)
