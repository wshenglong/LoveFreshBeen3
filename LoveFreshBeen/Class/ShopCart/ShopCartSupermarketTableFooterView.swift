...
class ShopCartSupermarketTableFooterView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        determineButton.setTitle("选好了", for: UIControlState())
        determineButton.setTitleColor(UIColor.black, for: UIControlState())
        determineButton.titleLabel?.font = UIFont.systemFont(ofSize: 14)
        determineButton.addTarget(self, action: "determineButtonClick", for: .touchUpInside)
